# Boas-vindas ao repositório do exercício Pokedex
...
Aprendemos sobre rotas e controllers. Isso levou nossa imaginação ao mundo Pokemon e agora você tem a oportunidade de desenvolver um item essencial para essa aventura. Uma pokedex. 

Lembre-se que para os testes, é necessário criar um mock para armazenar os pokemons em memória.
> Por exemplo: PokedexServiceFake, que implementará a interface criada e conterá, além das regras de negócio da implementação da interface, uma lista instanciada contendo alguns pokemons de exemplo
